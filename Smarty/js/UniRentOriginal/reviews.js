      ...
      reviews.forEach((review) => {
        ...
        if (user === "Admin") {
          ...
          if (review.statusReported === 1 || review.statusReported === true) {
            ...
            review.statusBanned === 1 ||
            review.statusBanned === true
          ) {
          ...
          if (typeof postedReviews !== "undefined" && postedReviews) {
            ...
            if (user === "Student") {
              if (review.type === "Accommodation") {
                ...
                hrefLink =
                  "/UniRent/Student/accommodation/" + review.idRecipient;
              } else {
            ...
            if (review.reported) {
              ...
              reportedWarning =
                '<h1 class="reported-warning" style="color: red; font-weight: bold; margin-left: 10px;">Reported</h1>';
            }
            additionalButtons =
              '<div class="btn-cont2"><button class="delete_button" id="deleteLink" data-review-id="` + review.id + `">Delete</button><button class="edit_button" data-review-id="` + review.id + `">Edit</button></div>';
            userSectionHTML =
              `
                            <p> To: </p>
                            <div ` +
              ...
              `>` +
              review.username +
              `</a></div> <!-- Username of the reviewer -->
                            <p class="reviewRecipType">` +
              review.type +
              `</p>
                        `;
          } else {
            additionalButtons =
              '<div class="btn-cont2"><button class="delete_button" data-review-id="` + review.id + `">Report</button></div>';
            userSectionHTML =
              `
                        <div class="userIcon">
                            <a href="` +
