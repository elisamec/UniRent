               ...
               <div class="profile_info">
                  <form class="form"  action="/UniRent/Owner/modifyOwnerProfile"  method="POST" id="yourFormId" enctype="multipart/form-data">
                     <div class="parentOW">
                        ...
                        <div class="div2">
                           <input class="profile-input" type="text" name="name" id="name" value="{$owner->getName()}" required>
                        </div>
                        <div class="div3"><p>Surname: </p></div>
                        <div class="div4">
                           <input class="profile-input" type="text" name="surname" id="surname" value="{$owner->getSurname()}" required>
                        </div>
                        ...
                        <div class="divOW1">
                           ...
                           <div class="divB">
                     <div class="delete_btn"><a href="/UniRent/Owner/deletePhoto"
                     {if $owner->getPhoto() === null}
                     class="disabled"
                     {/if}
                     >Delete Photo</a></div>
