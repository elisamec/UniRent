         ...
         <div class="row">
            <div class="col-md-10">
                  <div class="profile_info">
                     ...
                     <div class="col-md-3">
                     <div class="find_btn"><a href="#" onclick="openEditVisitModal()"> Edit</a></div>
                     <div class="delete_btn" id="deleteLink"><a href="#">Delete</a></div>
                     </div>
               </div>
               </div>
            <div class="col-md-2">
...
<div id="deleteConfirmModal" class="resModal">
    ...
    <div class="resModal-content">
        ...
        <h2>Delete Visit</h2>
            ...
            <div class="btn-cont">
            <button type="submit" id="confirmDelete" class="confirmClass">Delete</button>
            <button type="button" id="cancelDelete" class="cancelClass">Cancel</button>
            </div>
    </div>
...
<!-- footer section start -->
      ...
      <script src="/UniRent/Smarty/js/UniRentOriginal/timeslots.js"></script>
</body>
</html>