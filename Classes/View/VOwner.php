...
class VOwner {
     ...
     */
    public function profile(EOwner $owner, ?string $photo, ?string $modalSuccess){
    ...
    public function reviews(array $reviewsData, ?string $modalSuccess){
        $this->smarty->assign('reviewsData', $reviewsData);
        $this->smarty->assign('modalSuccess', $modalSuccess);
    ...
    public function publicProfileFromStudent(EOwner $owner, array $reviewsData, ?string $kind="#", ?string $modalSuccess){
        $this->smarty->assign('owner', $owner);
        $this->smarty->assign('reviewsData', $reviewsData);
        $this->smarty->assign('kind', $kind);
        $this->smarty->assign('modalSuccess', $modalSuccess);
    ...
    public function postedReview(array $reviewsData, ?string $modalSuccess){
        $this->smarty->assign('reviewsData', $reviewsData);
        $this->smarty->assign('modalSuccess', $modalSuccess);
